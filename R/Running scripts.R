...
LMSM_WGCNA_Biomarker <- module.BRCA.Biomarker(LncRNA_USE, RNASeqV2_USE, clinical_USE, LMSM_WGCNA_Modulegenes)
...
## BRCA biomarkers evaluation using hypergeometric distribution test
LMSM_SGFA_Biomarker <- module.BRCA.Biomarker(LncRNA_USE, RNASeqV2_USE, clinical_USE, LMSM_SGFA_Modulegenes)
