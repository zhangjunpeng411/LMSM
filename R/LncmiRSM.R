...
LncmiRSM <- function(miRExp, ceRExp, mRExp, miRTarget, CandidateModulegenes){   
...
## Determine the LncmiRSM modules belong to specific BRCA subtype
...
## Average and median correlation between sponge lncRNAs and mRNAs in each LncmiRSM module
module.avg.cor <- function(ceRExp, mRExp, Modulelist, resample = 100, method = c("mean", "median")) {
